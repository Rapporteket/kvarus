...
params:
  ...
  bins: 5
title: Samlerapport
subtitle: en rapport fra kvarus
author: Rapporteket
userFullName: Tore Tester
registryName: SKDE
reglogo: '`r system.file("logo.png", package = "kvarus")`'
regtext: '`r readLines(system.file("shortDescription.txt", package = "kvarus"))`'
...
f <- kvarus::makeHist(df = mtcars, var = params$var, bins = params$bins, makeTable = FALSE)
```
