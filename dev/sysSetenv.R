...
Sys.setenv(SHINYPROXY_APPID = "kvarus")
Sys.setenv(R_RAP_INSTANCE = "QAC")
Sys.setenv(MRS_ACCESS_HIERARCHY_URL = "https://app.mrs.nhn.no/kvarusregisterservices/AccessHiearchyReport")
